...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="Publisher">
        <AESDK:instanceId>Publisher</AESDK:instanceId>
        <AESDK:startup>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/Publisher.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBPublisher</AESDK:resource>
                    <AESDK:children>P_ADDRESS</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            ...
            <AESDK:adapterTester>
                ...
                <AESDK:workingDir>C:\Users\shahz\workspace_ADB1</AESDK:workingDir>
            </AESDK:adapterTester>
        </AESDK:designer>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:publishingTable>P_ADDRESS</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/Publisher.aeschema#class.P_ADDRESS</ADB:classReference>
                <ADB:sourceTable>ADDRESS</ADB:sourceTable>
                ...
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_ADDRESS</ADB:name>
                        <ADB:userKeys>ID</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
                <ADB:messageSubject>%%Domain%%.%%Deployment%%.adb.Publisher.ADBPublisher</ADB:messageSubject>
                <ADB:repoEndpointType>endpoint.JMSPublisher</ADB:repoEndpointType>
                <ADB:sessionReference>/Publisher.adb#jmsSession.JMSQueue</ADB:sessionReference>
                <ADB:preRegisteredListeners/>
                <ADB:destination>address</ADB:destination>
        ...
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:defaultDataSource xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:password>#!yVIgNjYlY9vK8yVh9iAtBcNOYrQGmNb5</ADB:password>
                <ADB:runtimePassword>#!sLIm9b/Q4a9IzAouXf9EeGb126bSc4sn</ADB:runtimePassword>
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\Publisher.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBPublisher">
        ...
        <AEService:destination>address</AEService:destination>
        ...
        <AEService:class isRef="true">/AESchemas/ae/ADB/Publisher.aeschema#class.P_ADDRESS</AEService:class>
