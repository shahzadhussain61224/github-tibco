...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ActiveDatabaseAdapterConfiguration">
        ...
        <AESDK:designer>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBPublisher</AESDK:resource>
                    <AESDK:children>P_BOS</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:destination>hello</ADB:destination>
                <ADB:publishingTable>P_BOS</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration.aeschema#class.P_BOS</ADB:classReference>
                <ADB:sourceTable>BOS</ADB:sourceTable>
                <ADB:columnsToPublish>SL_NO</ADB:columnsToPublish>
                <ADB:columnsToPublish>FIRST_NAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>MIDDLE_NAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>LAST_NAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>ACCOUNT_NO</ADB:columnsToPublish>
                <ADB:columnsToPublish>ACCOUNT_TYPE</ADB:columnsToPublish>
                <ADB:columnsToPublish>CREDIT_AMOUNT</ADB:columnsToPublish>
                <ADB:columnsToPublish>DEBIT_AMOUNT</ADB:columnsToPublish>
                <ADB:columnsToPublish>TOTAL_BALANCE</ADB:columnsToPublish>
                <ADB:columnsToPublish>STREET</ADB:columnsToPublish>
                ...
                <ADB:columnsToPublish>SSN_NO</ADB:columnsToPublish>
                <ADB:columnsToPublish>AADHAR_NO</ADB:columnsToPublish>
                <ADB:columnsToPublish>PAN_NO</ADB:columnsToPublish>
                <ADB:columnsToPublish>POSTAL_CODE</ADB:columnsToPublish>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBPublisher">
        ...
        <AEService:destination>hello</AEService:destination>
        ...
        <AEService:class isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration.aeschema#class.P_BOS</AEService:class>
