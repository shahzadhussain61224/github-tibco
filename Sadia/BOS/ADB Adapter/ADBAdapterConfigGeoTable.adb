...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ADBAdapterConfigGeoTable">
        <AESDK:instanceId>ADBAdapterConfigGeoTable</AESDK:instanceId>
        <AESDK:startup>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/ADBAdapterConfigGeoTable.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBPublisher</AESDK:resource>
                    <AESDK:children>P_GEO</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            ...
            <AESDK:adapterTester>
                ...
                <AESDK:workingDir>C:\Users\shahz\workspace_ADB</AESDK:workingDir>
            </AESDK:adapterTester>
        </AESDK:designer>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:publishingTable>P_GEO</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ADBAdapterConfigGeoTable.aeschema#class.P_GEO</ADB:classReference>
                <ADB:sourceTable>COUNTRY_TABLE</ADB:sourceTable>
                <ADB:columnsToPublish>SL_NO</ADB:columnsToPublish>
                <ADB:columnsToPublish>COUNTRY</ADB:columnsToPublish>
                <ADB:columnsToPublish>REGION</ADB:columnsToPublish>
                <ADB:userDefinedKey>SL_NO</ADB:userDefinedKey>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_COUNTRY_TABLE</ADB:name>
                        <ADB:userKeys>SL_NO</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>GeoTable</ADB:destination>
                ...
                <ADB:sessionReference>/ADB Adapter/ADBAdapterConfigGeoTable.adb#jmsSession.JMSQueue</ADB:sessionReference>
            </ADB:publisher>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:defaultDataSource xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:password>#!75vJOpi9skcVxNmDTU0942T9hoZqY9Ma</ADB:password>
                <ADB:runtimePassword>#!MSPxHG0tx/PBa3eIvNfxLzIW+m7mnGDs</ADB:runtimePassword>
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\ADBAdapterConfigGeoTable.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBPublisher">
        ...
        <AEService:destination>GeoTable</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/ADBAdapterConfigGeoTable.aeschema#class.P_GEO</AEService:class>
