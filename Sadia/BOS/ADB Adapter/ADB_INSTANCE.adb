...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ADB_INSTANCE">
        <AESDK:instanceId>ADB_INSTANCE</AESDK:instanceId>
        <AESDK:startup>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/ADB_INSTANCE.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBPublisher</AESDK:resource>
                    <AESDK:children>P_RETAIL</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:publishingTable>P_RETAIL</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ADB_INSTANCE.aeschema#class.P_RETAIL</ADB:classReference>
                <ADB:sourceTable>RETAIL</ADB:sourceTable>
                <ADB:columnsToPublish>RANK</ADB:columnsToPublish>
                <ADB:columnsToPublish>COMPANY</ADB:columnsToPublish>
                <ADB:columnsToPublish>SALES_2017</ADB:columnsToPublish>
                <ADB:columnsToPublish>HQ_CITY</ADB:columnsToPublish>
                <ADB:columnsToPublish>HQ_STATE</ADB:columnsToPublish>
                <ADB:columnsToPublish>STORE</ADB:columnsToPublish>
                <ADB:userDefinedKey>RANK</ADB:userDefinedKey>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        <ADB:name>P_RETAIL</ADB:name>
                        <ADB:userKeys>RANK</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>RETAIL</ADB:destination>
        ...
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\ADB_INSTANCE.sql</ADB:scriptFileName>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBPublisher">
        ...
        <AEService:destination>RETAIL</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/ADB_INSTANCE.aeschema#class.P_RETAIL</AEService:class>
