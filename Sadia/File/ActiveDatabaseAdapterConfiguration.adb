...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ActiveDatabaseAdapterConfiguration">
        ...
        <AESDK:deployment>
            ...
            <AESDK:sessions>
                <AESDK:messaging>
                    ...
                    <AESDK:jmsSession isRef="true">#jmsSession.JMS</AESDK:jmsSession>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    ...
                    <AESDK:properties>deliveryMode,subject,name,destination,wireFormat</AESDK:properties>
                </AESDK:locked>
                <AESDK:locked>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/ADBPublisher</AESDK:resource>
                    <AESDK:children>P_LOG</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            ...
            <AESDK:adapterTester>
                <AESDK:exe>C:\tibco5x\adapter\adadb\7.1\bin\adbagent.exe</AESDK:exe>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:publisher xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.publisher">
                ...
                <ADB:destination>adb.log</ADB:destination>
                <ADB:publishingTable>P_LOG</ADB:publishingTable>
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration.aeschema#class.P_LOG</ADB:classReference>
                <ADB:sourceTable>DBO_LOG</ADB:sourceTable>
                <ADB:columnsToPublish>APPLICATION_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>LOG_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>COMPONENT_NAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>HOST_NAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>TRANSACTION_DOMAIN</ADB:columnsToPublish>
                <ADB:columnsToPublish>TRANSACTION_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>TRANSACTION_TYPE</ADB:columnsToPublish>
                <ADB:columnsToPublish>TIME_STAMP</ADB:columnsToPublish>
                <ADB:columnsToPublish>TIME_DURATION</ADB:columnsToPublish>
                <ADB:columnsToPublish>CATEGORY</ADB:columnsToPublish>
                <ADB:columnsToPublish>MESSAGE</ADB:columnsToPublish>
                <ADB:columnsToPublish>STATUS</ADB:columnsToPublish>
                <ADB:columnsToPublish>TRANSACTION_DATA</ADB:columnsToPublish>
                <ADB:columnsToPublish>FILE_NAME</ADB:columnsToPublish>
                <ADB:columnsToPublish>LOG_AUDIT</ADB:columnsToPublish>
                <ADB:columnsToPublish>INTERFACE_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>TRANSACTION_SIZE</ADB:columnsToPublish>
                <ADB:columnsToPublish>DATA_ENCODING</ADB:columnsToPublish>
                <ADB:columnsToPublish>CORRELATION_ID</ADB:columnsToPublish>
                <ADB:columnsToPublish>RENDER_ID</ADB:columnsToPublish>
        ...
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:defaultDataSource xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                <ADB:name/>
                <ADB:user>c##admin</ADB:user>
                <ADB:driver>oracle.jdbc.driver.OracleDriver</ADB:driver>
                <ADB:url>jdbc:oracle:thin:@localhost:1521:ORCL</ADB:url>
                <ADB:runtimeUser>c##admin</ADB:runtimeUser>
                ...
                <ADB:password>#!f3M2Te/RdMTOBEDL0udvS8vpYRA9dm88</ADB:password>
                <ADB:runtimePassword>#!/dvckScLyvdO4y0MVFKlu6kHaPlhQZsV</ADB:runtimePassword>
    ...
    <AEService:jmsSession xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="session.JMS" name="JMS">
        <AEService:clientId/>
    ...
    <AEService:jmsProducer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSPublisher" name="ADBPublisher">
        ...
        <AEService:destination>adb.log</AEService:destination>
        ...
        <AEService:class isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration.aeschema#class.P_LOG</AEService:class>
